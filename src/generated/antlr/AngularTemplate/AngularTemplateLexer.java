...
public class AngularTemplateLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"LT", "GT", "SLASH", "LPAREN", "RPAREN", "DOT", "COMMA", "ASSIGN", "BINDING_START", 
			"BINDING_END", "DIGIT", "SPECIAL_TAG_NAME", "ID", "PROPERTY", "INTERPOLATION_STRING", 
			"IDENTIFIER_STRING", "FUNCTION_CALL_STRING", "NUMBER", "STRING", "INTERPOLATION", 
			"NG_FOR", "NG_IF", "WS", "COMMENT", "TOKEN"
		};
	}
	...
	public AngularTemplateLexer(CharStream input) {
		super(input);
